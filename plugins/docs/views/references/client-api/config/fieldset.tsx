...
const fieldset = client.fieldset.contact.config`,
//1-------------------------------------------------------------------//
...
type Contact { 
  address Address @field.fieldset
}`,
//4-------------------------------------------------------------------//
`type Contact { 
...
export function Head(props: ServerPageProps<ServerConfigProps>) {
  ...
  const { _ } = useLanguage();
  //variables
  const title = _('Fieldset Configuration - Client API - References - Stackpress Documentation');
  const description = _(
  ...
  return (
    <article className="px-h-100-0 overflow-auto px-px-20 px-pb-20 px-fs-15">
      ...
      <section>
        ...
        <Code>{'type Contact @icon("user") {}'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.icon //--> 'user'`}</Code>
      </section>
      ...
      <section>
        <P>
          Returns the fieldset <C>@label</C> names. This is an array of 
        ...
        <Code>{'type Contact @label("Contact" "Contacts") {}'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.label //--> [ 'Contact', 'Contacts' ]`}</Code>
      </section>
      ...
      <section>
        <P>
          Returns the fieldset plural <C>@label</C>.
        </P>
        ...
        <Code>{`fieldset.plural //--> 'Contacts'`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.singular //--> 'Contact'`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.camel //--> 'contact'`}</Code>
        <Code>{`fieldset.camel //--> 'addressBook'`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.dash //--> 'contact'`}</Code>
        <Code>{`fieldset.dash //--> 'address-book'`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.lower //--> 'contact'`}</Code>
        <Code>{`fieldset.lower //--> 'addressbook'`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.snake //--> 'contact'`}</Code>
        <Code>{`fieldset.snake //--> 'address_book'`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.title //--> 'Contact'`}</Code>
        <Code>{`fieldset.title //--> 'AddressBook'`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.enums //--> [ Column { name: 'relationship' } ]`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.fieldsets //--> [ Column { name: 'address' } ]`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{'type Contact { name String @field.text }'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.fields //--> [ Column { name: 'name' } ]`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{'type Contact { name String }'}</Code>
        <Code>{'type Contact { name String @list.text }'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.lists //--> [ Column { name: 'name' } ]`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{'type Contact { name String }'}</Code>
        <Code>{'type Contact { name String @view.text }'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.views //--> [ Column { name: 'name' } ]`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{'type Contact { name String @is.requried("Required") @is.cgt(4 "Should be > 4") }'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.assertions //--> [ Column { name: 'name' } ]`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{'type Contact { type String @default("person") }'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.defaults //--> [ Column { name: 'type' } ]`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{'type Contact { email String @encrypted }'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.encrypted //--> [ Column { name: 'email' } ]`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{'type Contact @template("{{name}}") {}'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.template //--> '{{name}}'`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.assert({ name: 'john' })`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.column('name') //--> Column { name: 'name' }`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.assert({ name: 'john', foo: bar }) //--> { name: 'john' }`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.input({ name: 'john', email: 'john@email.com', foo: bar }) //--> { name, email }`}</Code>
        <Code>{`fieldset.input({ name: 'john', email: 'john@email.com', foo: bar }, true) //--> { name }`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{'type Contact @template("Hi {{name}}") {}'}</Code>

        <H4>Code Example</H4>

        <Code>{`fieldset.render({ name: 'john' }) //--> 'Hi john'`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.serialize({ active: true, created: new Date }) //--> { active: 1, created: '2025-01-01T00:00:00Z' }`}</Code>
      </section>
      ...
      <section>
        ...
        <Code>{`fieldset.unserialize({ active: 1, created: '2025-01-01T00:00:00Z' }) //--> { active: true, created: Date }`}</Code>
      </section>
