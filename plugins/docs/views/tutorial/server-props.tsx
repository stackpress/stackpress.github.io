...
export function Head(props: ServerPageProps<ServerConfigProps>) {
  ...
  const { _ } = useLanguage();
  //variables
  const title = _('3. Server Props - Stackpress Tutorial');
  const description = _(
...
export function Body() {
  ...
  return (
    <article className="px-h-100-0 overflow-auto px-px-20 px-pb-20 px-fs-15">
      <H2>Recap</H2>
      <P>
        The last section covered how to add a page route to your 
        application and how a view can consume the response. Get caught 
        up by making sure your project looks like the following.
      </P>
      ...
      <P>
        The next section will cover setting up the default context 
        provider in order to enable the default <SS>Stackpress</SS> toolset.
      </P>
      
      <Nav
        prev={{ text: '2. Server Routes', href: '/docs/tutorial/server-routes' }}
        next={{ text: '4. Context Provider', href: '/docs/tutorial/context-provider' }}
      />
    </article>
  );
}
