...
export function Head(props: ServerPageProps<ServerConfigProps>) {
  ...
  const { _ } = useLanguage();
  //variables
  const title = _('2. Server Routes - Stackpress Tutorial');
  const description = _(
...
export function Body() {
  ...
  return (
    <article className="px-h-100-0 overflow-auto px-px-20 px-pb-20 px-fs-15">
      ...
      <H1>2. Server Routes</H1>

      <P>
        The following section explains how to add a page route to your
        application and how a view can optionally consume the response. 
      ...
      <Note>
        ...
        view from the page route. This way, you can toggle everything in 
        one file.
      </Note>
      ...
      <Nav
        prev={{ text: '1. Plugin Architecture', href: '/docs/tutorial/plugin-architecture' }}
        next={{ text: '3. Server Props', href: '/docs/tutorial/server-props' }}
      />
    </article>
  );
}
